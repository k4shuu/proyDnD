...
public class Weapon extends Item {
    ...
    static {
        ...
        ALL_WEAPONS.add(new Weapon("Longbow", 2, 50 * Currency.GP.getCopperValue(),
                Category.MARTIAL_RANGED, EnumSet.of(Props.AMMUNITION, Props.HEAVY, Props.TWO_HANDED), 1, 8, 0, false, DmgType.PIERCING));

        ALL_WEAPONS.add(new Weapon("Net", 3, Currency.GP.getCopperValue(),
